...
namespace VintageAPI.Controllers
{
    ...
    public class TbCategoriaController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public Task<DO.Objetos.TbCategoria> Get(string id)
        {
        ...
        public Task<IEnumerable<DO.Objetos.TbCategoria>> customQuery(string query)
        {
            return new BS.TbCategoria().customQuery(query);
        }
    }
}